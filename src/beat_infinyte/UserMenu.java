...
public class UserMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        UserIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/usercirculo.png"))); // NOI18N

        UsernameText.setFont(new java.awt.Font("Perpetua", 0, 24)); // NOI18N
    ...
    //Metodo para mostrar el nombre de usuario
    public void mostarUser(int id_user) {
		//String username = "";
		String query = "SELECT username FROM Usuario WHERE id_user = ?";
		...
		try {
			...
			System.out.println("Fallo al realizar la query: " + sqle);
		}
